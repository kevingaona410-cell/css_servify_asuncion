...
// Referencias a los estados del perfil individual 
...
const providerProfile = document.querySelector(".provider-profile"); // se oculta si hay error y se muestra si el find tiene éxito
